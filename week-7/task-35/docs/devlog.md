...
```
git_files: 1 файл(ов) в week-7/task-35
...
```
git ls-files week-7/task-35   →  0 файлов   (старое поведение)
...
запись** (`?? week-7/task-35/`). Мы печатали «рабочее дерево: 1 изменённых файл(ов)» — за этой
