...
func main() {
	...
	s.AddTool(&mcp.Tool{
		...
		InputSchema: json.RawMessage(`{
			"type":"object",
			"properties":{
				"path":{"type":"string","description":"Префикс пути, напр. 'week-7/task-33' или 'week-7/task-33/docs'. Пусто = весь репозиторий."},
...
func branchInfo(ctx context.Context, repo string) (string, error) {
	...
	// каталоги в одну запись (`?? week-7/task-33/`). Мы печатали «рабочее дерево: 1
